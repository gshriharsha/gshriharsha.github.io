export const site = {
  ...
  about: [
    ...
    "Beyond architecture, I lead and mentor engineering teams through the full delivery lifecycle — owning design reviews, Architecture Review Board sign-off, sprint planning, and career development. I've led onshore and offshore Salesforce engineering pods across multiple organizations, established engineering standards and design patterns, and partnered with Sales, RevOps, Finance, and Product leadership to align platform decisions with business outcomes.",
  ],
  email: "harshasfdc001@gmail.com",
  location: "Remote · India · Open to Global",
  availability:
    "Open to Architect & Lead Developer Roles · India · Remote Preferred",
  links: {
    linkedin: "https://www.linkedin.com/in/s-harsha1/",
    github: "https://github.com/gshriharsha",
    resume: "resume.pdf",
  },
  stats: [
